...
{
	public partial class VJeekWaterMarkController : BasePluginController
	{
		...
		{
			int scopeConfiguration = this.GetActiveStoreScopeConfiguration (this._storeService, this._workContext);
